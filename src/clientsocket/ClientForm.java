...
public class ClientForm extends javax.swing.JFrame {
     ...
     */
    private ClientSocketService css;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!this.jTextField3.getText().isEmpty() && !this.jTextField4.getText().isEmpty()) {
            css.setMensagem(nome + " diz :" + this.jTextField2.getText());
            this.jTextArea1.setText(css.getMensagem());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (!this.jTextField3.getText().isEmpty() && !this.jTextField4.getText().isEmpty()) {
            ...
            try {
                css = new ClientSocketService(ip, port);                
